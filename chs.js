...
var cnItems = {
    ...
    "Mystical :": "神秘 :",
    "To Surface": "前往地表",
    "Warning: High mine capacities with this pickaxe may lead to game crashes.": "警告:这把镐子的高矿容量可能会导致游戏崩溃。",
    "What happens when I dig down?": "当我往下挖时会发生什么?",
    "What is \"Void Prevention\"?": "什么是“虚空预防”?",
    "World 1 gears will NOT work in world 2, except for the ore tracker.": "除了矿石追踪器外，世界1的装备将无法在世界2中使用。",
    "Will roll 1 extra time for a variant if an ore is normal.": "如果一个矿石是正常的，将为一个变体额外掷 1 次。",
    "Background music made by the community! (ty<3)": "由社区制作的背景音乐!(ty<3)",
    "Biome Enchanter": "生物魔法师",
    "Clover's Undoing": "三叶草的毁灭",
    "Created Webhoook Ids": "已创建Webhoook ID",
    "Dimensional:": "维度:",
    "Display is Disabled.": "显示为禁用状态。",
    "Electrified": "电气化",
    "Electrifying Propagator": "通电传播器",
    "Ethereal": "空灵",
    "Ethereal :": "空灵 :",
    "For every block mined, gives you an additional layer block from the current layer.": "对于挖掘的每个块，从当前层中获得一个额外的层块。",
    "Force Cloud Save (Galaxy)": "强制云保存 (仅在Galaxy)",
    "Hey! I notice you mined a Flawless tier ore!": "嘿!我注意到你挖了一个完美的矿石!",
    "Here's where you combine worse ores into a better ore.": "在这里，你可以把劣质矿石组合成优质矿石。",
    "Here's where you break a better ore down into worse ores.": "在这里你可以把优质矿石分解成劣质矿石。",
    "Icon Needed, submit in #media and ping me!": "需要图标，提交到 #media 后联系我!",
    "If you have the link to the Silly Caverns tracker, enter the link and your discord username below.": "如果你有愚蠢洞穴追踪器的链接，在下面输入链接和你的discord用户名。",
    "If you want a webhook for another server, create a custom ID below. Name is the name that will appear in the embed, can be a ping. Rarity is the rarity that the ID will check, is a number >1 that represents the RNG you want to webhook (The ID chosen depends on the rarity of the ore, with the embed being sent to the link that the rarity falls under). ID is the ID that the information will fall under. Link is the webhook link you want to use for that ID.": "如果您想为另一台服务器创建webhook，请在下面创建一个自定义ID。Name是将出现在嵌入中的名称，可以是ping。稀有性是ID将检查的稀有性，是一个>1的数字，代表你想要webhook的RNG(选择的ID取决于矿石的稀有性，嵌入被发送到稀有性所属的链接)。ID是信息所属的ID。Link是要用于该ID的webhook链接。",
    "In World 2 and Subrealm 1, the last layer of the world will keep generating infinitely as you go down. In World 1, there's a special mechanic that keeps generating layers the further down you go.": "在世界2和子领域1中，世界的最后一层将随着你往下走而无限生成。在 世界1 中，有一个特殊的机制会让你越往下走越产生层。",
    "Increases cave spawn chance, cave size, and cave luck for 2:30 minutes. Has a cooldown of 15 minutes": "增加洞穴生成几率，洞穴大小和洞穴运气，持续2:30分钟。有15分钟的冷却时间",
    "Leafy greens cloud your vision...": "绿叶蔬菜遮蔽了你的视线……",
    "Latest Finds Will Appear Here": "最新发现将出现在这里",
    "Many ideas by @viridescentluna on Discord!": "@viridescentluna在Discord上提出了许多想法!",
    "Stormseer's Superspark Sceptre": "风暴者超级公园权杖",
    "The celestials required to craft it:": "制作它所需的天文学家：",
    "The data tab has everything with your data. Pressing export will paste your save file into the text box, and asks if you want to download it as a file. It is recommended to make backups of your data regularly in case browser data is lost. Paste data into the text box and press import to import that data. This will overwrite your current data, so make sure it is what you want. Importing nothing performs a hard reset on your game.": "数据选项卡包含所有数据。按 导出 会将保存的文件粘贴到文本框中，并询问是否要将其作为文件下载。建议定期备份数据，以防浏览器数据丢失。将数据粘贴到文本框中，然后按 导入 导入该数据。这将覆盖您当前的游戏数据，因此请确保这是您想要的。不导入任何内容会对游戏进行硬重置。",
    "The ore index tab gives you information on the ores in each layer in the world you are currently in. Higher tiers will be blacked out until the ore is found. Each index card will also tell you the rarity of the ore, how rare it is with your current luck, and what variants of the ore you own.": "矿石索引选项卡为你提供当前世界中每一层矿石的信息。更高的等级将被封锁，直到找到矿石。每张索引卡也会告诉你矿石的稀有程度，你目前的运气有多稀有，以及你拥有的矿石的变种。",
    "The passage of time seems to speed up as it's source is unearthed...": "时间的流逝似乎随着它的源头的挖掘而加速……",
    "The pickaxe resonates with a distant entity.. a signal sent from far beyond these lands. Further traces of it are found within the blueprint for a particular craft of a key, one designed to open the lock to a completely new world..": "镐子与远处的物体产生共鸣。一个从这片土地之外传来的信号。在一种特殊工艺的钥匙的蓝图中发现了更多的痕迹，这把钥匙被设计成打开一个全新世界的锁。",
    "The settings tab allows you to change many things about the game (explained in the settings section). It is also where you can control spawn sound volume, and determine what spawn sounds get played.": "设置选项卡允许您更改游戏的许多内容(在设置部分中解释)。你也可以在这里控制刷出声音的音量，并决定播放什么刷出声音。",
    "The Portal Room": "传送门房间",
    "The settings tab allows you to change many things about the game (explained in the settings section). It is also where you can control spawn sound volume, and determine what spawn sounds get played.": "设置选项卡允许您更改游戏的许多内容(在设置部分中解释)。你也可以在这里控制刷出声音的音量，并决定播放什么刷出声音。",
    "The skies begin to glow as a cosmic body enchants the mine...": "天空开始发光，一个宇宙物体使矿井着迷……",
    "The Spelunker": "洞穴探险者",
    "The statistics tab shows you some things about yourself, such as total ores owned in the rare tiers, total time played, session time, blocks mined, and caves generated (more statistics will come eventually).": "统计选项卡会显示一些关于你自己的信息，例如稀有层中拥有的矿石总数，总游戏时间，会话时间，开采的方块和生成的洞穴(更多的统计数据将最终出现)。",
    "The tides in the 🌊 drop out into the ocean, lowering a path into the depth...": "🌊的潮汐落入海洋，在深处留下了一条路……",
    "These caves can spawn any layer Antique+, excluding Celestial tier ores, from any world, with a 1/1000 cave spawn chance.": "这些洞穴可以从任何世界生成任何层古董+，不包括天界层矿石，有1/1000的洞穴生成机会。",
    "These layers are usually repeated versions of the main layers, with a small chance to have something added to them. There are also a few secret layers that have a very low chance of generating. These special layers, along with the lowest point you've been, will be added to the teleport list on generation. An index page for the secret layers will also be created once you have mined a certain amount in those layers.": "这些层通常是主要层的重复版本，很少有机会添加一些内容。还有一些秘密层的生成几率非常低。这些特殊的层，以及你所处的最低点，将在生成时添加到传送列表中。一旦您在这些层中挖掘了一定数量的数据，就会创建秘密层的索引页面。",
    "These settings allow you to specify if clicking an ore in a crafting recipe or in the normal inventory will open the index page for it.": "这些设置允许你指定在制作配方或普通库存中点击一个矿石是否会打开它的索引页面。",
    "This section will be spoilered in case people do not want to reveal how to find certain layers or want to figure things out for themselves. Click on the section to reveal the text.": "如果人们不想透露如何找到某些层或想自己弄清楚事情，这部分将被剧透。单击该部分以显示文本。",
    "Common": "常见",
    "Craft!": "制作!",
    "Equipped!": "已装备！",
    "Your vision expands as your head spikes with an adrenaline rush...": "当你的肾上腺素激增时，你的视野扩大了……",
    "Game made by @thecatofalltime on Discord! 😺": "游戏由@thecatofalltime在Discord上制作!😺",
    "Gears are like upgrades, with each one having an effect to make progression easier. Below is a list of the current gears that are active:": "装备就像升级一样，每一个都能够让游戏进程变得更简单。以下是当前活跃的装备列表:",
    "Generates a Silly Layer at a random position in the Repeating Layers.": "在重复图层的随机位置生成一个愚蠢的图层。",
    "Has 2x special cave type luck and slightly increased cave size.": "有2倍的特殊洞穴运气和稍微增加的洞穴大小。",
    "Has a 50% chance to give you 2 extra layer blocks upon mining a layer block.": "有50%的机会在挖掘一个层块时给你两个额外的层块。",
    "Has a 25% chance to multiply normal ability size by 4x and simulted ability size by 2x.": "有25%的几率将普通技能大小乘以4倍，将模拟技能大小乘以2倍。",
    "Has the power of pickaxe 0.": "拥有鹤嘴锄0的力量。",
    "": "",
    "": "",
    "": "",
    "": "",
...
var cnPrefix = {
    ...
    "Active for ": "持续时间 ",
    "Can use in ": "可用时间 ",
    "Decreases base mining speed by ": "降低基础采矿时间 ",
    "": "",
    "": "",
    "": "",
    "": "",
...
var cnPostfix = {
    ...
    " Caves Generated.": " 洞窟生成。",
    " Flawless Tier Ores Owned.": " 完美的矿石拥有。",
    " 🔘 Owned.": " 🔘 拥有.",
    "/Infinity": "/无限",
    "/??? Base Rarity.": "/??? 基础稀有度.",
    "/??? With Luck.": "/??? 通过幸运.",
